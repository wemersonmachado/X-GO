...
export const AUDIT_ACTIONS = [
  ...
  "finance.catalog_created",
  "finance.catalog_updated",
  "finance.agent_permission_changed",
  "finance.proposal_created",
  "finance.proposal_approved",
  "finance.proposal_rejected",
  "finance.document_uploaded",
  "finance.document_removed",
  "finance.import_created",
  "finance.transaction_reconciled",
  "finance.chart_account_created",
  "finance.chart_account_updated",
  "finance.entry_classified",
  "finance.fiscal_requested",
  "finance.fiscal_submitted",
  "billing.subscription_synced",
  "billing.preference_updated",
