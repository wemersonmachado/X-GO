...
export const DICIONARIO: Traducoes = {
  ...
  "Sem centro de custo": { es: "Sin centro de costos" },
  "Sem conta financeira": { es: "Sin cuenta financiera" },
  "Filtrar lançamentos": { es: "Filtrar registros" },
  "município": { es: "municipio" },
  "Importação e conciliação de extratos": { es: "Importación y conciliación de extractos" },
  "Envie CSV ou OFX de até 2 MB. Importar não baixa lançamentos; a conciliação também precisa de aceite humano.": { es: "Envía un archivo CSV u OFX de hasta 2 MB. Importar no liquida registros; la conciliación también requiere aprobación humana." },
  "Arquivo CSV ou OFX": { es: "Archivo CSV u OFX" },
  "Importar para revisão": { es: "Importar para revisión" },
  "Extrato importado": { es: "Extracto importado" },
  "Selecione um extrato": { es: "Selecciona un extracto" },
  "Nenhuma movimentação encontrada neste extrato.": { es: "No se encontraron movimientos en este extracto." },
  "Movimentações do extrato": { es: "Movimientos del extracto" },
  "Lançamento correspondente": { es: "Registro correspondiente" },
  "Selecione um lançamento": { es: "Selecciona un registro" },
  "Recebimento": { es: "Cobro" },
  "Conciliado": { es: "Conciliado" },
  "Ignorado": { es: "Ignorado" },
  "Conciliar": { es: "Conciliar" },
  "Aguarda uma pessoa administradora para decidir a conciliação.": { es: "Espera a que una persona administradora decida la conciliación." },
  "Vincular este movimento ao lançamento selecionado? A baixa continua separada.": { es: "¿Vincular este movimiento al registro seleccionado? La liquidación sigue siendo independiente." },
  "Ignorar este movimento do extrato?": { es: "¿Ignorar este movimiento del extracto?" },
  "Extrato importado para revisão.": { es: "Extracto importado para revisión." },
  "Movimento conciliado. A baixa permanece uma confirmação separada.": { es: "Movimiento conciliado. La liquidación sigue siendo una confirmación independiente." },
  "Movimento ignorado.": { es: "Movimiento ignorado." },
  "Falha no financeiro.": { es: "Error en finanzas." },
  "Plano de contas e DRE gerencial": { es: "Plan de cuentas y estado de resultados gerencial" },
  "A DRE usa competência, inclui lançamentos em aberto e exclui os cancelados. Não é demonstrativo contábil.": { es: "El estado de resultados usa el criterio de devengo, incluye registros abiertos y excluye los cancelados. No es un estado contable." },
  "Criar conta gerencial": { es: "Crear cuenta gerencial" },
  "Plano de contas": { es: "Plan de cuentas" },
  "Nenhuma conta gerencial cadastrada.": { es: "No hay cuentas gerenciales registradas." },
  "Classificar lançamento": { es: "Clasificar registro" },
  "Competência": { es: "Devengo" },
  "Conta gerencial": { es: "Cuenta gerencial" },
  "Sem conta": { es: "Sin cuenta" },
  "Salvar classificação": { es: "Guardar clasificación" },
  "Mês da DRE": { es: "Mes del estado de resultados" },
  "Ver DRE": { es: "Ver estado de resultados" },
  "Receitas": { es: "Ingresos" },
  "Despesas": { es: "Gastos" },
  "lançamento(s) sem competência ficam fora da DRE.": { es: "registro(s) sin devengo quedan fuera del estado de resultados." },
  "Fila fiscal do Brasil": { es: "Cola fiscal de Brasil" },
  "Não há provedor configurado. A solicitação fica aguardando integração e nenhuma nota é emitida.": { es: "No hay ningún proveedor configurado. La solicitud espera integración y no se emite ninguna factura." },
  "Município IBGE": { es: "Municipio IBGE" },
  "Registrar solicitação": { es: "Registrar solicitud" },
  "Solicitações fiscais": { es: "Solicitudes fiscales" },
  "Nenhuma solicitação fiscal registrada.": { es: "No hay solicitudes fiscales registradas." },
  "Solicitação fiscal registrada na fila de integração.": { es: "Solicitud fiscal registrada en la cola de integración." },
  "Anexos privados": { es: "Adjuntos privados" },
  "PDF, PNG ou JPEG de até 10 MB. Os arquivos ficam vinculados ao lançamento e não são públicos.": { es: "PDF, PNG o JPEG de hasta 10 MB. Los archivos quedan vinculados al registro y no son públicos." },
  "PDF ou imagem": { es: "PDF o imagen" },
  "Nenhum anexo neste lançamento.": { es: "No hay adjuntos en este registro." },
  "Anexos do lançamento": { es: "Adjuntos del registro" },
  "Abrir": { es: "Abrir" },
  "Anexo privado enviado.": { es: "Adjunto privado enviado." },
  "Anexo aberto em outra aba.": { es: "Adjunto abierto en otra pestaña." },
  "Anexo excluído.": { es: "Adjunto eliminado." },
  "Excluir o anexo": { es: "¿Eliminar el adjunto" },
  "Esta ação não pode ser desfeita.": { es: "Esta acción no se puede deshacer." },
  "Envie um arquivo CSV ou OFX de até 2 MB.": { es: "Envía un archivo CSV u OFX de hasta 2 MB." },
  "Envie PDF, PNG ou JPEG de até 10 MB.": { es: "Envía un PDF, PNG o JPEG de hasta 10 MB." },
  "Informe um mês no formato AAAA-MM.": { es: "Indica un mes con el formato AAAA-MM." },
  "DRE atualizada.": { es: "Estado de resultados actualizado." },
  "Conta gerencial criada.": { es: "Cuenta gerencial creada." },
  "Classificação do lançamento salva.": { es: "Clasificación del registro guardada." },
  "Registrar solicitação fiscal? Sem provedor escolhido, nenhuma nota será enviada.": { es: "¿Registrar solicitud fiscal? Sin un proveedor elegido, no se enviará ninguna factura." },
  "Cadastros financeiros": { es: "Catálogos financieros" },
  "Cadastro": { es: "Catálogo" },
  "Categorias": { es: "Categorías" },
  "Centro de custo": { es: "Centro de costos" },
  "Centros de custo": { es: "Centros de costos" },
  "Conta financeira": { es: "Cuenta financiera" },
  "Contas financeiras": { es: "Cuentas financieras" },
  ...
  "Receita": { es: "Ingreso" },
  "Despesa": { es: "Gasto" },
  "Nenhum cadastro ainda.": { es: "Todavía no hay registros." },
  "Delegação ao agente": { es: "Delegación al agente" },
  "Cada operação começa desabilitada. O agente só prepara propostas; uma pessoa administradora decide.": { es: "Cada operación comienza deshabilitada. El agente solo prepara propuestas; una persona administradora decide." },
  "Operação": { es: "Operación" },
  "Limite por proposta (R$)": { es: "Límite por propuesta (R$)" },
  "Sem limite definido": { es: "Sin límite definido" },
  "Informe um limite maior que zero.": { es: "Indica un límite mayor que cero." },
  "Permitir propostas": { es: "Permitir propuestas" },
  "Permissão atual": { es: "Permiso actual" },
  "Propor": { es: "Proponer" },
  "Desabilitada": { es: "Deshabilitada" },
  "Ative também a ferramenta financeira no perfil do agente.": { es: "Activa también la herramienta financiera en el perfil del agente." },
  "Abrir agentes": { es: "Abrir agentes" },
  "Propostas financeiras": { es: "Propuestas financieras" },
  "Aprovar um pagamento, reembolso, desconto, transferência ou compromisso não executa a operação externa.": { es: "Aprobar un pago, reembolso, descuento, transferencia o compromiso no ejecuta la operación externa." },
  "Nenhuma proposta financeira pendente.": { es: "No hay propuestas financieras pendientes." },
  "Aprovar esta proposta? Nenhum pagamento ou transferência será executado por esta aprovação.": { es: "¿Aprobar esta propuesta? Esta aprobación no ejecutará ningún pago ni transferencia." },
  "Rejeitar esta proposta?": { es: "¿Rechazar esta propuesta?" },
  "Selecione": { es: "Selecciona" },
  "Lançamento": { es: "Registro" },
  "Pagamento": { es: "Pago" },
  "Reembolso": { es: "Reembolso" },
  "Desconto": { es: "Descuento" },
  "Transferência": { es: "Transferencia" },
  "Compromisso financeiro": { es: "Compromiso financiero" },
  "Rejeitada": { es: "Rechazada" },
  "O agente prepara propostas financeiras. Pagamentos, reembolsos e transferências exigem aprovação humana e conector autorizado para execução.": { es: "El agente prepara propuestas financieras. Los pagos, reembolsos y transferencias requieren aprobación humana y un conector autorizado para ejecutarse." },
  ...
  "Respostas de IA neste mês": { es: "Respuestas de IA este mes" },
  "Limite incluído atingido.": { es: "Se alcanzó el límite incluido." },
  "Consumo próximo do limite.": { es: "Consumo próximo al límite." },
  "créditos pré-pagos disponíveis": { es: "créditos prepagados disponibles" },
  "Pode compensar migrar para": { es: "Puede convenir migrar a" },
  "antes de acumular adicionais.": { es: "antes de acumular adicionales." },
  "/mês": { es: "/mes" },
  "Ao atingir a franquia de IA": { es: "Al alcanzar la franquicia de IA" },
  "Bloquear novas respostas da IA": { es: "Bloquear nuevas respuestas de IA" },
  "Consumir créditos pré-pagos": { es: "Consumir créditos prepagados" },
  "Cobrar excedente até o teto": { es: "Cobrar excedente hasta el límite" },
  "Salvar política": { es: "Guardar política" },
  "Excedente:": { es: "Excedente:" },
  "teto": { es: "límite" },
  "Adicionar capacidade": { es: "Agregar capacidad" },
  "A compra abre o checkout seguro da Stripe. A capacidade é liberada automaticamente após a confirmação do pagamento.": { es: "La compra abre el checkout seguro de Stripe. La capacidad se libera automáticamente después de la confirmación del pago." },
  "Contratar adicional": { es: "Contratar adicional" },
  "Créditos pré-pagos de IA": { es: "Créditos prepagados de IA" },
  "Compra única. O saldo entra automaticamente após o pagamento e não altera sua mensalidade.": { es: "Compra única. El saldo se acredita automáticamente después del pago y no modifica tu mensualidad." },
  "Comprar créditos": { es: "Comprar créditos" },
  ...
  "Pagamentos": { es: "Pagos" },
  "Checkout dinâmico via Stripe e eventos recebidos.": { es: "Checkout dinámico vía Stripe y eventos recibidos." },
  "configurado": { es: "configurado" },
  "não configurado": { es: "no configurado" },
  "Os valores são alterados em Configurações da landing e cobrados no próximo checkout — não há link fixo pra sincronizar.": { es: "Los valores se cambian en Configuración de la landing y se cobran en el próximo checkout — no hay enlace fijo que sincronizar." },
  "Inativo — checkout indisponível": { es: "Inactivo — checkout no disponible" },
