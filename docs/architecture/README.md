...
| arquivo | escopo |
|---|---|
| `financeiro.architecture.json` | contas a pagar/receber, delegação por proposta, conciliação, DRE por competência, fila fiscal sem provedor, isolamento e confirmação humana; não movimenta dinheiro |
